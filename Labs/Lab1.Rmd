...
### Markdown Syntax
You will write your report using plain text, using markdown syntax for formatting. Here's an overview of syntax for you to try on your own directly from the Cheatsheet:
